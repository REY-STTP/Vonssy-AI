        ...
        <div className="flex min-w-0 items-center gap-1">
          ...
          {isRenaming ? (
            <input
              ...
              aria-label={t("chatHeader.renameChatLabel")}
            />
          ) : (
            <button
              type="button"
              ...
              title={sessionTitle || t("chatHeader.newChat")}
              aria-label={`${sessionTitle || t("chatHeader.newChat")}, ${t("chatHeader.renameChatLabel")}`}
            >
              {sessionTitle || t("chatHeader.newChat")}
            </button>
          )}
          ...
          <button
            ...
            aria-label={t("chatHeader.chatOptions")}
            aria-haspopup="menu"
