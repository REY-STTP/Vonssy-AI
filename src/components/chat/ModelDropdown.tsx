...
export default function ModelDropdown({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-5 w-64 max-h-40 overflow-y-auto bg-surface border border-border rounded-xl shadow-dropdown p-2 animate-dropdown-enter z-50">
